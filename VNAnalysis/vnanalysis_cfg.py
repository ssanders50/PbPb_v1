...
process.vnanalyzer.chi2 = cms.untracked.double(9.0)
process.vnanalyzer.dzdzerror_pix = cms.untracked.double(6.0)
process.vnanalyzer.dzdzerror_ = cms.untracked.double(2.0)
process.vnanalyzer.d0d0error_ = cms.untracked.double(2.0)
process.vnanalyzer.pterrorpt_ = cms.untracked.double(0.05)
