...
GetEventInfo::GetEventInfo(TString inFile){
  ...
  for(int i = 0; i<nkeys; i++) {
    ...
    TH2D * h2 = (TH2D *) tfin->Get(Form("%s/qxtrk2",flist->At(i)->GetName()));
    if(h2==0) return;
    ...
    hTemplate->GetXaxis()->SetTitleFont(43);
    hTemplate->GetYaxis()->SetTitleFont(43);
    hTemplate->GetXaxis()->SetLabelFont(43);
    hTemplate->GetYaxis()->SetLabelFont(43);
    hTemplate->GetXaxis()->SetTitleSize(24);
    hTemplate->GetXaxis()->SetLabelSize(18);
    hTemplate->GetYaxis()->SetTitleSize(24);
    hTemplate->GetYaxis()->SetLabelSize(18);
